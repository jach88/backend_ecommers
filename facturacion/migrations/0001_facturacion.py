# Generated by Django 3.2.7 on 2021-10-16 05:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('manejoEc', '0003_cambioDeSubtotal'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido', models.OneToOneField(db_column='pedido_id', on_delete=django.db.models.deletion.CASCADE, related_name='pedidoComprobante', to='manejoEc.pedidomodel')),
            ],
            options={
